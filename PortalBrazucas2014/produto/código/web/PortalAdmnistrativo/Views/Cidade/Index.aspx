...
<asp:Content ID="IndexTitulo" ContentPlaceHolderID="TitleContent" runat="server">
    <%: PortalAdmnistrativo.Resouces.Cidade.CasoUso %>
</asp:Content>
...
<asp:Content ID="IndexConteudo" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="painel_filtros">
        <% Html.RenderPartial("_painelFiltros", (PortalAdmnistrativo.Models.Cidade)ViewBag.Parametros); %>
    </div>
    <div class='painel_titulo'><%: PortalAdmnistrativo.Resouces.Geral.pnlTituloResultado %></div>
    <div id="resultado">
        <% Html.RenderPartial("_painelResultados", (IEnumerable<PortalAdmnistrativo.Models.Cidade>)ViewBag.Resultados); %>
    </div>
