...
<div id="divDestaquePrincipal" onclick="javascript:redirecionaNoticia('<%: Model.CodigoNoticia %>')" style="cursor: pointer;">
    ...
    <div style="background-image: url('<%: Model.CaminhoImagem %>'); background-position: center; background-size: contain; background-repeat: no-repeat; width: 450px; height: 200px;"></div>
