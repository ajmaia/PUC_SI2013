...
<% if(String.IsNullOrEmpty(Model.Conteudo)) { %>
    <div style="font-size: 16px; color: darkgreen; font-weight: bold; padding-bottom: 3px; text-align: center; width: 300px;"><%: Model.Titulo %></div>
    <div style="float: left; background-image: url('<%: Model.CaminhoImagem %>'); background-position: center; background-repeat: no-repeat; width: 300px; height: 131px; margin-top: 3px;"></div>
